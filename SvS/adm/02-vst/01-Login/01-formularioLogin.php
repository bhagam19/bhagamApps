<div id="appsFormulario" class="appsFormularioLogin">
	<div>	
		<div>
			<table border=0>
				<form method="POST" action="index.php" onsubmit="return validarLogin(this.usuarioLogin.value,this.contrasenaLogin.value);">		
					<tr>
					...
					<tr>
						...
						<input  class="btnLogin" type="button" onclick="mostrarFormularios('.appsFormularioNuevoUsuario')" value="Créala aquí"/>
					</td>
					</tr>
				</form>
			</table>  
