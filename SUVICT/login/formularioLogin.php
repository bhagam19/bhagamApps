<div id="formulario" class="formularioLogin">
	<div class="acceso-registrado">	
		<!-- <?php //include('../login/formularioNuevoUsuario.php'); ?> -->
		<div>
			<table class="nuevo-usuario" border=0>
				<form method="POST" action="principal.php" onsubmit="return validarLogin(this.usuarioLogin.value,this.contrasenaLogin.value);">		
					<tr>
