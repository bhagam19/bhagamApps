...
<head>
    ...
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1, maximun-scale=1.0, minimun-scale=0.2"/>
    <title>Resultados Evaluar para Avanzar</title>
    <link rel="shortcut icon" href="../appsArt/EvPAv.png"/>
