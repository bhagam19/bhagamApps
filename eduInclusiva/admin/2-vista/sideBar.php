<?php
    ...
    $path1=$path."/negocioNormal/admin/";
    $_SESSION['path'] = $path1;
    $pathCrear = "/negocioNormal/admin/2-vista/crudUsuario/insertar.html";
    $pathVer = "/negocioNormal/admin/3-control/clientesVer.php";
    $pathPerfiles="/negocioNormal/admin/2-vista/crudPerfiles/";
    $pathPerfilesxUsuario="/negocioNormal/admin/2-vista/crudPerfilesxUsuario/";
?>
<!-- Sidebar -->
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">

<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="/negocioNormal/admin/index.php">
...
<?php
    $path .= "/negocioNormal/admin/1-model/conex.php";
    include($path);
...
<li class="nav-item active">
    ...
    <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/negocioNormal/admin/2-vista/topBar.php">Blank Page</a>
        </div>
    </div>-->
</li>
