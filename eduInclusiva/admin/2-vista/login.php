<?php
    ...
    $path1=$path."/victor-UAI-MED/admin/";
    $_SESSION['path'] = $path1;
    $_SESSION['path1'] ="http://localhost/victor/victor-UAI-MED/admin/1-model/";
    $_SESSION['path2'] ="http://localhost/victor/victor-UAI-MED//admin/2-vista/";
    $_SESSION['path3'] ="http://localhost/victor/victor-UAI-MED//admin/3-control/";
?>
<!DOCTYPE html>
<html lang="es">
