...
<html>
	<head>
		...
		<title>Sistema de Inventario IE Tapartó</title>
	...
	<body>				
		<div id="contenedor">	
			<div id="cinta" style="margin-bottom:5px;background:#ff0000;color:white;border-radius:10px;font-weight:bold;">
				<ul style="position:relative;list-style:none;display:inline;">
					<li style="position:relative;list-style:none;display:inline;padding:10px;margin:10px;">SISTEMA DE INVENTARIO - IE TAPARTÓ 2019</li>
...
?>
	...
	<div id="piedepagina">
			   <div class="contenido-piedepagina content">
					<ul>
						<li>© 2019 Sistema de Inventarios </li>
