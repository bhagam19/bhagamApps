<?php
	...
	if(!isset($_SESSION['usuario'])){
		...
		if($codigo==3){
			...
			'
				<div id="baseDeDatos">
					<div class="baseDeDatos">
						<span id="tituloBD">NOMINACIONES REALIZADAS</span>
						<br><br>
						<table class="tablaBD">
							<thead>
								<tr>
									...
									<td class="encabezadoTabla"><img class="imgOrden" src="../art/ordenarAZ.svg" title="Ordenar Ascendente" onclick="ordenarSugerencias(0,\'razones\')"/><img class="imgOrden" src="../art/ordenarZA.svg" title="Ordenar Descendente" onclick="ordenarSugerencias(1,\'razones\')"/><br>CONDICION</td>		
									<td class="encabezadoTabla"><img class="imgOrden" src="../art/ordenarAZ.svg" title="Ordenar Ascendente" onclick="ordenarSugerencias(0,\'argumentos\')"/><img class="imgOrden" src="../art/ordenarZA.svg" title="Ordenar Descendente" onclick="ordenarSugerencias(1,\'argumentos\')"/><br>DESCRIPCIÓN</td>
									<td class="encabezadoTabla"><img class="imgOrden" src="../art/ordenarAZ.svg" title="Ordenar Ascendente" onclick="ordenarSugerencias(0,\'argumentos\')"/><img class="imgOrden" src="../art/ordenarZA.svg" title="Ordenar Descendente" onclick="ordenarSugerencias(1,\'argumentos\')"/><br>FRECUENCIA</td>															
								</tr>					
   							</thead>
			...
			include('12-cargarNominaciones.php');
