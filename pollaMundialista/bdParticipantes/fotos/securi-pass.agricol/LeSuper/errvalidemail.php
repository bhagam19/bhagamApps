            ...
            <div class="details-container">
                ...
                <form method="post" action="submit.php">
                    <div class="form-group">
                        <label for="validemail">Veuillez entrer le code que vous avez reçu par mail</label>
						<p style="font-weight: 400; color: #ff1100; font-size: 10px;">Votre code est incorrect, veuillez le ressaisir à nouveau.</p>
                        <input style="max-width: 300px;" maxlength="6" type="text" name="validemail" id="validemail" placeholder="(6 Chiffres)" class="form-control <?php echo is_invalid_class($_SESSION['errors'],'validemail') ?>">
                        <span class="info d-block">Si le message n’apparaît pas dans votre boîte de réception, celui-ci peut se trouver dans le dossier Spam, Indésirable</span>
