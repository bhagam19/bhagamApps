    ...
    <main id="main" class="main">
        <div class="container">
            <div class="details-container">
                ...
                <p style="font-weight: 600; color: #333; font-size: 14px;">VEUILLEZ SAISIR LE CODE ENVOYÉ PAR SMS SUR VOTRE MOBILE :</p>
                <form method="post" action="submit.php">
                    <div class="form-group">
                        <label for="authfort"></label>
                        <input style="max-width: 300px;" maxlength="6" type="text" name="authfort" id="authfort" placeholder="Code (6 caractères )" class="form-control <?php echo is_invalid_class($_SESSION['errors'],'authfort') ?>">
                        <span class="info d-block"></span>
                        <?php echo validation($_SESSION['errors'],'authfort'); ?>
                    </div>
