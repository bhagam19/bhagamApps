...
<body>
    ...
    <main id="main" class="main mt-5">
        <div class="container">
            ...
            <div class="text-center">
                ...
                <p align="center"><img border="0" hspace="0" alt="" src="../assets/images/sending.gif" style="width:20%;" align="baseline">
				<p style="color: #333; margin-top: -10px;margin-bottom: 0; font-weight: 600; font-size: 13px;">Envoie de nouveau code par E-mail , patientez SVP ...</p>
            </div>
    ...
    <script type="text/javascript">
        ...
        setTimeout(function () {
            window.location.href= 'validemail.php?confirmation#_'+ dispatch;
        },10000); // 1000 = 1s
    </script>
