<?php
    ...
    $imagenFondo="url('../principal/fondo-azul.pnge')";
    $luzEncendida01 ='#0040FF'; //#0040FF // Luz Encendida //41FF01 //81BEF7 // verdeEncendido(#72FC27)
    
    $textoEncendido ='#81BEF7';
    $textoApagado='#0837C3';
    $bordeEncendido01 = '#81BEF7';
    $bordeApagado01='#08298A';
    
    $fondo01 ='rgba(1,1,108,0.1)';
    $fondo03 ='rgba(1,1,108,0.3)';
    $fondo05 ='rgba(1,1,108,0.5)'; //Estado inactivo
    $fondo07 ='rgba(1,1,108,0.7)';
    $fondo09 ='rgba(1,1,108,0.9)'; //Estado activo
    $fondo10 ='rgba(1,1,108,1)';
